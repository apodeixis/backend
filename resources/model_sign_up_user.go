...
// checks if the SignUpUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SignUpUser{}
...
type _SignUpUser SignUpUser

// NewSignUpUser instantiates a new SignUpUser object
...
// NewSignUpUserWithDefaults instantiates a new SignUpUser object
...
func (o *SignUpUser) GetAttributes() SignUpUserAllOfAttributes {
	if o == nil {
		var ret SignUpUserAllOfAttributes
		return ret
	}
...
func (o *SignUpUser) UnmarshalJSON(data []byte) (err error) {
	...
	varSignUpUser := _SignUpUser{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSignUpUser)

	if err != nil {
		return err
	}

	*o = SignUpUser(varSignUpUser)
...
func NewNullableSignUpUser(val *SignUpUser) *NullableSignUpUser {
	return &NullableSignUpUser{value: val, isSet: true}
}
