...
// checks if the LoginUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LoginUser{}
...
type _LoginUser LoginUser

// NewLoginUser instantiates a new LoginUser object
...
// NewLoginUserWithDefaults instantiates a new LoginUser object
...
func (o *LoginUser) GetAttributes() LoginUserAllOfAttributes {
	if o == nil {
		var ret LoginUserAllOfAttributes
		return ret
	}
...
func (o *LoginUser) UnmarshalJSON(data []byte) (err error) {
	...
	varLoginUser := _LoginUser{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLoginUser)

	if err != nil {
		return err
	}

	*o = LoginUser(varLoginUser)
...
func NewNullableLoginUser(val *LoginUser) *NullableLoginUser {
	return &NullableLoginUser{value: val, isSet: true}
}
